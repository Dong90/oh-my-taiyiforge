...
<!-- taiyi:deep-fix-smoke --> 2026-07-05
...
> **Release**: `0.4.2` | **Date**: 2026-07-05 | **Status**: deployed
...
**触发**: break **操作**: 1. revert 2. npm test **时间**: ≤5min
...
- **Version**: `0.4.2` | **Date**: 2026-07-05 | **Artifacts**: npm
