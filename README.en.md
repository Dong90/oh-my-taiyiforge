...
| v0.40.0 | ✅ Released | review date binding + SSOT cross-refs · E2E fixtures extended 7 fields · graph context compression · CI/Playwright/vitest timeout fixes |
| v1.0.0 | ✅ Released | 9-stage API lock · 4-platform parity (OpenCode / Claude Code / Codex / CLI) · first stable release |
| v1.1.0 | ✅ Latest | registry refactor · 9-stage E2E coverage · agent CLI hardening · hono CVE fix |
