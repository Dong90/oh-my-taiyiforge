...
|-------|------|:--:|---------|
| Round 1 · 功能 | 全部 AC | ✅ 必跑 | — |
| Round 2 · 性能 | Lighthouse / k6 / bundle | 待定 | N/A — CLI change, no perf surface |
| Round 3 · 安全 | 依赖审计 / SAST / OWASP | 待定 | N/A — no new attack surface |
| Round 4 · 兼容 | 浏览器 / 视口 / 数据迁移 | 待定 | N/A — CLI only |
| Round 5 · 可观测 | 日志 / 指标 / 告警 | 待定 | N/A — standard CLI stdout/stderr |
...
- **T-01**: 无参数 help 输出所有命令 `[passed]`
- **T-02**: help <name> 输出单命令详情 `[passed]`
