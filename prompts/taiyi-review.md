...
---
description: "TaiyiForge /taiyi:review — Review 域 umbrella · loop / check / health"
argument-hint: "<loop|check|health> [args]"
---
User invoked **$taiyi-review** (= `/taiyi:review $ARGUMENTS`). **Review 域 umbrella · 拆给 3 个子命令 prompt**：
...
2. 加载 `@taiyi-review-loop` · `@taiyi-review-check` · `@taiyi-health`
