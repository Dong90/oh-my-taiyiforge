...
export const PHASE_WRITE_HINTS: Record<PhaseId, PhaseWriteHint> = {
  ...
  requirement: {
    ...
    external: [],
    slashExtras: [],
    notes: ["Schema 驱动：executor.generateStageData(RequirementSchema) → persistAndRender"],
  },
  design: {
    superpowers: [],
    superpowersOptional: [],
    ...
    notes: ["Schema 驱动：executor.generateStageData(DesignSchema) → persistAndRender"],
  },
  "ui-design": {
    superpowers: [],
    superpowersOptional: [],
    ...
    external: [],
    slashExtras: [],
    notes: ["Schema 驱动：executor.generateStageData(UiDesignSchema) → persistAndRender"],
  },
  task: {
    superpowers: [],
    superpowersOptional: [],
    ...
    external: [],
    slashExtras: [],
    notes: ["Schema 驱动：executor.generateStageData(TaskSchema) → persistAndRender"],
  },
  dev: {
    ...
    auxiliary: [],
    external: [],
    slashExtras: ["/taiyi:apply", "/taiyi:ultrawork"],
  ...
  test: {
    ...
    external: [],
    slashExtras: [],
    notes: ["Schema 驱动：executor.generateStageData(TestSchema) → persistAndRender"],
  },
  review: {
    superpowers: [],
    superpowersOptional: [],
    auxiliary: ["taiyi-health"],
    external: ["/taiyi:gstack review"],
    slashExtras: ["/taiyi:review-loop"],
    notes: ["Schema 驱动：executor.generateStageData(ReviewSchema) → persistAndRender"],
  },
  integration: {
    superpowers: [],
    superpowersOptional: [],
    auxiliary: [],
    external: [],
    slashExtras: ["/taiyi:commit"],
    notes: ["Schema 驱动：executor.generateStageData(IntegrationSchema) → persistAndRender"],
  },
  requirement: {
    superpowers: [],
    superpowersOptional: [],
