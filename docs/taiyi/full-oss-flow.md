...
```bash
npx taiyi-forge-install --all          # Superpowers · gstack · OpenSpec · web-quality-skills
npx taiyi doctor
...
| 6 | 打卡（有 UI 时） | 上表 gstack/web-quality 各项 |
| 7 | 过关 | `/taiyi:continue` |

纯 API/CLI 项目：ui-design 可标 N/A，跳过 gstack/web-quality 打卡。
...
| test | verification-before-completion | gstack/qa · playwright · web-quality |
| review | requesting-code-review | gstack/review · semgrep · trivy · taiyi-health |
| integration | finishing-a-development-branch · verification | gstack/document-release · openspec · changesets |
...
- [superpowers-flow.md](./superpowers-flow.md) — Superpowers 主轴摘要
- [integrations.md](./integrations.md) — 铁三角安装
- [tdd-workflow.md](./tdd-workflow.md) — dev 门禁
