...
const SLASH_PROMPTS: Record<string, string> = {
  ...
  "taiyi-diagram-arch.md": "/taiyi:diagram-arch",
  "taiyi-diagram-c4.md": "/taiyi:diagram-c4",
  "taiyi-diagram-render.md": "/taiyi:diagram-render",
  "taiyi-diagram-pipeline.md": "/taiyi:diagram-pipeline",
  "taiyi-diagram-flow.md": "/taiyi:diagram-flow",
