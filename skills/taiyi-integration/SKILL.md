...
```bash
npx taiyi sync-openspec <slug>   # TEST/REVIEW/CHANGELOG 一并映射
npx taiyi archive <slug>         # OpenSpec 归档
```
...
`npx taiyi complete <slug> integration`

## 完成后

- `npx taiyi list` — 该 slug 应显示 integration 完成
- 可开新 slug 或 archive
